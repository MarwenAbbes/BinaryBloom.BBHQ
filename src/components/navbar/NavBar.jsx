...
import {FinancialOperations, Operation} from "../../Classes/GlobalConstents";
import LocalPrintshopIcon from "@mui/icons-material/LocalPrintshop";
import AlertBar from "../Utilities/AlertBar/AlertBar";
import {OrderDetails} from "../Sales/Order/OrderDetails";
...
function NavBar() {
    ...
    return (
        <>
            ...
            <OrderDetails showModal={showModel} setShowModal={setShowModel} elementName={FinancialOperations.INVOICE}
                          operation={Operation.Add} setData={undefined} alert={alert} setAlert={setAlert}/>
            {alert.show &&
                            ...
                            <ul className="navbar-nav ml-auto navbar-list align-items-center">
                                <li className="nav-item nav-icon">
                                    <a href="#" className="btn border add-btn shadow-none mx-2 d-none d-md-block"
                                       data-toggle="modal" data-target="#new-order" onClick={() => {
                                        setShowModel(true)
                                    }}>
                                        <AddOutlinedIcon/>
                                        New Order</a>
